...
public class VistaPrincipal extends JFrame {
    ...
    private JPanel crearPanelProductos() {
        ...
        JPanel formulario = new JPanel(); // Aquí añadimos los campos faltantes
        formulario.add(new JLabel("ID:")); formulario.add(txtIdProd);
        formulario.add(new JLabel("Nombre:")); formulario.add(txtNomProd);
        formulario.add(new JLabel("Descripción:")); formulario.add(txtDescProd); // <--- Faltaba este
    ...
    private JPanel crearPanelClientes() {
        JPanel panel = new JPanel(new BorderLayout());
        JPanel formulario = new JPanel(new GridLayout(2, 4)); // Grid para que quepan todos
        formulario.add(new JLabel("ID:")); formulario.add(txtIdCli);
        formulario.add(new JLabel("Nombre:")); formulario.add(txtNomCli);
        formulario.add(new JLabel("Apellido:")); formulario.add(txtApeCli); // <--- Faltaba
        formulario.add(new JLabel("Teléfono:")); formulario.add(txtTelCli); // <--- Faltaba
        formulario.add(new JLabel("Dirección:")); formulario.add(txtDirCli); // <--- Faltaba
